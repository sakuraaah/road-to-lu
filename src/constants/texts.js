export const STEP1_TEXT = [
  `
  Pirmais posms manā ceļojumā uz Latvijas Universitāti sākas ar iziešanu no mājas. Man ir jābūt gatavam laikus, lai nepalaistu garām autobusu, un kad esmu pārliecinājies, ka viss ir kārtībā, es izeju no mājas un dodos uz tuvāko sabiedriskā transporta pieturu. Ceļš uz pieturu man parasti aizņem apmēram piecas minūtes, un šajā laikā es bieži klausos mūziku.
  `,
  `
  Kad esmu nonācis pieturā, es gaidu 49. autobusu. Parasti šajā pieturā ir diezgan daudz cilvēku, un dažreiz nākas mazliet pagaidīt, līdz autobuss atnāk. Kad autobuss pienāk, es iekāpju un meklēju brīvu vietu, kur apsēsties. Autobusa brauciens manā ceļojumā ir viens no svarīgākajiem posmiem, jo tas mani ved pāri Dienvidu tiltam, kas ir nozīmīgs punkts ceļā uz LU.
  `,
  `
  Brauciens ar autobusu neaizņem ļoti ilgu laiku - tas ir piecu minūšu brauciens, jo Dienvidu tilts atrodas netālu no manas mājas, un beidzot tas noved mani līdz manam otram ceļojuma posmam - braucienam ar tramvaju līdz centram.
  `
];
...
export const STEP6_TEXT = [
  `
  Kad es atbraucu ar tramvaju līdz Dienvidu tiltam, es atkal gaidu 15., 31. vai 49. autobusu, lai tiktu līdz mājai. Kā var redzēt bildē, āra jau ir tumši, bet tas ir galvenokārt jo šī bilde bija uztaisīta ziemā, kad diena ir īsa un nakts ir gara. Tomēr es aprakstīšu savu dienas beigu tādu, kāda tā bija bildes uzņemšanas brīdī.
  `,
  `
...
export const MAP_TEXT = [
  `
  Šajā sadaļā var vizuāli apskatīt manu maršrutu no mājas līdz Latvijas Universitātei. Šeit ir piedāvātas arī citas maršruta opcijas, kurus es neaprakstīju, tomēr viņus es izmantoju daudz retāk, jo tie ir vai nu ilgākie, vai nu ar ceļa sastrēgumiem, vai nu vienkārši nebrauc man vajadzīgā laikā.
  `,
  `
  Mana ceļojuma maršruts uz Latvijas Universitāti ir rūpīgi plānots, lai nodrošinātu efektīvu un ērtu pārvietošanos pa Rīgu. Sākot no mājas Pļavniekos, es izmantoju sabiedriskā transporta līdzekļus, piemēram 49. autobuss, kas aizved mani līdz Dienvidu tiltam. No turienes es pārbraucu uz 7. tramvaju, kas mani ved garām Nacionālajai operai un Operas parkam, līdz es sasniedzu Latvijas Universitātes tuvumā esošo pieturu. Šis ceļojums ar sabiedriskā transporta līdzekļiem nodrošina ērtu un ātru pārvietošanos, piedāvājot skatus uz pilsētas panorāmu un apkārtējo vidi.
  `,
  `
  Plānojot ceļojumu, es ņemu vērā transporta numurus, maršrutu laikus un iespējamās pārbraukšanas pieturvietas, lai nodrošinātu savlaicīgu ierašanos uz nodarbībām un tikšanām. Šāds rūpīgi izstrādāts maršruts palīdz saglabāt manu ikdienas ritmu un efektīvi pārvaldīt laiku.
  `
]

export const SUMMARY_TEXT = [
  `
  Mana ceļojuma izskats uz Latvijas Universitāti ir kā aizraujoša piedzīvojuma stāsts, sākot ar mājas atstāšanu un nonākot līdz LU durvīm. Katrs posms, sākot ar 49. autobusu un turpinot ar 7. tramvaju, ir kā mazs piedzīvojums pats par sevi, piedāvājot skatus uz skaistajām Rīgas ielām un panorāmām. Parks un Nacionālā opera kļūst par ceļa iezīmēm, atgādinot par pilsētas skaistumu un vēsturi. Laiks, kas ir nepieciešams, lai man tikt no mājas līdz Latvijas Universitātei, ir aptuveni 60 minūtes, atkarībā no satiksmes intensitātes un pārvietošanās līdzekļu grafika. Runājot par distanci, maršruts aizņem apmēram 9 kilometrus (jo man jābrauc gandrīz caur visu Rīgu).
  `,
  `
  Kad es atgriežos mājās, kur mājoklis gaida mani ar siltumu un mājīgumu, es sajūtu, ka esmu atgriezies pie saknēm. Katrs solis ceļā sniedz iespēju pārdomāt un izbaudīt mūsu apkārtējo pasauli, radot atmiņas un iespaidus, kas padara šo ikdienas ceļojumu par īpašu piedzīvojumu. Es esmu gatavs sagaidīt nākamo dienu ar svaigu prātu un jaunām iespējām, zinot, ka mana ceļojuma stāsts turpināsies arvien jaunos un aizraujošos veidos.
  `
]